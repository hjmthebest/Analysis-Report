    ...
    with enuri_standard as (
        select t1.dpstr_cust_no
            ...
            left join lpciddm.tb_dmcu_yrexcllcustgrdeinfo_i t2
                on (t1.dpstr_cust_no = t2.dpstr_cust_no) and (t2.excll_cust_slct_yy = date_format(date_sub(current_date(), 1), 'yyyy')) -- D-1일 기준 당해년도 등급만 확인
            ...
            where 1 = 1
                ...
                and t1.lmt_st_dt between '2023-01-01' and '2023-12-31'                                                       -- 에누리적용기간: 2023년 
